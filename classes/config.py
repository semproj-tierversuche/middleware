...
class ConfigReader(object):
    ...
    def readExcludeRules(self, Node):
        ...
        for Node in Nodes:
            if "flag" not in Node.attrib:
                continue
            allzweckWegwerfVariable = Node.attrib["flag"].strip()
            #Why the hack has python no switch and case...narf
            if "contains" == allzweckWegwerfVariable:
                Return["contains"].append(Node.text.strip())
            elif "date" == allzweckWegwerfVariable:
                Return["date"].append(Node.text.strip())
            elif "endswith" == allzweckWegwerfVariable:
                Return["ending"].append(Node.text.strip())
            elif "pattern" == allzweckWegwerfVariable:
    ...
    def readResources(self):
        ...
        #raise Exception
            ...
            for Node in Nodes:
                self._Resources = self.readResource(Node)
